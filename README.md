...
| [`@nx-devkit/prepare-for-release`](./packages/prepare-for-release/README.md) | `tools/project.json` | `prepare-for-release` target — idempotent npm placeholder publishing |
